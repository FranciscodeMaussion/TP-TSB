...
public class TSBHashtableDA<K, V> implements Map<K, V>, Cloneable, Serializable {
     ...
     * implementación además, el arreglo de com.tsb.soporte vuelve a tener el tamaño que
     ...
     * en cada una de las listas del arreglo table que se usa como com.tsb.soporte de
...
=======
     * eliminar un objeto (remove()), eliminar el contenido (clear) y la
>>>>>>> 39af862a877065eeb3e4629528901a279e7c103a
